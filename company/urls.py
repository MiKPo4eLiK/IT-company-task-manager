...
urlpatterns = [
    ...
    path("workers/<int:pk>/update/", WorkerLicenseUpdateView.as_view(), name="worker-update"),
    ...
    path("tasks/<int:pk>/toggle-assign/", ToggleAssignView.as_view(), name="toggle-assign-to-worker")
]
